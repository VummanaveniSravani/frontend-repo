...
const EnterMarksEce = ({ onSubmit }) => {
  ...
  return (
    <div>
      <h3>Elctronics and Computer Science and Engineering</h3>
      <form onSubmit={handleSubmit}>
        <div className='py-5'>
          ...
          <div className='d-flex gap-5 align-items-center justify-content-between'>
            ...
            />
            <select className="form-control mb-3"  value={grade}
