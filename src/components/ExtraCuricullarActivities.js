...
const ExtraCuricullarActivities = ({ onActivityAdded = () => {} }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`https://improved-fiesta-9rxvp57wwrqh464-3000.app.github.dev/eactivity`, eActivity, {
        headers: {
  ...
  const fetchStudentActivities = async (rollNo) => {
    try {
      const response = await axios.get(`https://improved-fiesta-9rxvp57wwrqh464-3000.app.github.dev/eactivity?rollNo=${rollNo}`);
